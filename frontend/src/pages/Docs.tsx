        ...
        <div className="max-w-4xl mx-auto space-y-16">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  >
                    <p className="text-xs text-[#52525b] mb-2 font-mono">cURL Example:</p>
                    <code className="text-sm text-[#fafafa] font-mono break-all block">
              ...
              >
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    ...
                    >
                      <p className="text-xs text-[#52525b] mb-2 font-mono">Installation:</p>
                      <code className="text-sm text-[#fafafa] font-mono block space-y-1">
                        <div className="text-[#52525b]"># Clone the repository</div>
                        <div>git clone https://github.com/ethan10clay/promptredteam-api.git</div>
                        <div>cd promptredteam-api</div>
                        <div className="mt-2 text-[#52525b]"># Install dependencies</div>
                        <div>pip install -r requirements.txt</div>
                        <div className="mt-2 text-[#52525b]"># Run the API server</div>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="px-6 py-5 border-b border-[#27272a] flex items-start justify-between">
                  <div>
                    <h3 className="text-[1.125rem] font-semibold text-[#fafafa] font-mono">POST /test</h3>
                    <p className="text-sm text-[#52525b] mt-1">Test a prompt for security vulnerabilities</p>
                  </div>
                  <span 
                ...
                <div className="p-6 space-y-6">
                  ...
                  {/* Request */}
                  <div>
                    <h4 className="font-semibold mb-3 text-[#fafafa]">Request Body</h4>
                    <div 
                      className="p-4 rounded-lg"
                      style={{ background: '#18181b' }}
                    >
                      <code className="text-sm font-mono text-[#fafafa] block space-y-1">
                        <div>&#123;</div>
                        <div>&nbsp;&nbsp;<span style={{ color: '#4ade80' }}>"text"</span>: <span style={{ color: '#4ade80' }}>"string"</span> <span className="text-[#52525b]">// Required, max 10000 chars</span></div>
                        <div>&#125;</div>
                      </code>
                    </div>
                  </div>
                  ...
                  {/* Response */}
                  <div>
                    <h4 className="font-semibold mb-3 text-[#fafafa]">Response (200 OK)</h4>
                    <div 
                  ...
                  {/* Error Responses */}
                  <div>
                    <h4 className="font-semibold mb-3 text-[#fafafa]">Error Responses</h4>
                    <div className="space-y-3">
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          <span className="font-mono text-sm text-[#fafafa]">400 Bad Request</span>
                        </div>
                        <p className="text-sm text-[#a1a1aa]">Invalid input (missing text, too long, invalid format)</p>
                      </div>
                      <div 
                        className="p-4 rounded-lg"
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          <span className="font-mono text-sm text-[#fafafa]">429 Too Many Requests</span>
                        </div>
                        <p className="text-sm text-[#a1a1aa]">Rate limit exceeded (demo API only)</p>
                      </div>
                      <div 
                        className="p-4 rounded-lg"
                        style={{ background: '#18181b', borderLeft: '3px solid #ef4444' }}
                      >
                        <div className="flex items-start justify-between mb-2">
                          <span className="font-mono text-sm text-[#fafafa]">500 Internal Server Error</span>
                        </div>
                        <p className="text-sm text-[#a1a1aa]">Server error during processing</p>
                      </div>
                    </div>
                  </div>
              ...
              >
                <div className="px-6 py-5 border-b border-[#27272a]">
                  <h3 className="text-[1.125rem] font-semibold text-[#fafafa] font-mono">GET /health</h3>
                  <p className="text-sm text-[#52525b] mt-1">Check API health status</p>
                </div>
                <div className="p-6 space-y-6">
            ...
            >
              <div className="p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold mb-3 text-[#fafafa] flex items-center gap-2">
                      <div 
                    ...
                    <ul className="space-y-2 text-sm text-[#a1a1aa]">
                      <li className="flex gap-2">
                        <span className="text-[#52525b] mt-1">•</span>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                <div className="px-6 py-5 border-b border-[#27272a]">
                  <h3 className="text-[1rem] font-semibold text-[#fafafa] flex items-center gap-2">
                    <div 
                      className="w-2 h-2 rounded-full"
                      style={{ background: '#22c55e' }}
                    />
                ...
                <div className="p-6">
                  <ul className="space-y-3 text-sm text-[#a1a1aa]">
                    ...
                    <li className="flex gap-2">
                      <span className="text-[#22c55e] mt-1">•</span>
                      <span>Monitor for new attack patterns</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              >
                ...
                <div className="p-6">
                  <ul className="space-y-3 text-sm text-[#a1a1aa]">
                    ...
                    <li className="flex gap-2">
                      <span className="text-[#ef4444] mt-1">•</span>
                      <span>Don't forget to update regularly</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#ef4444] mt-1">•</span>
                      <span>Don't bypass security for convenience</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <p className="font-semibold text-[#fafafa]">GitHub Repository</p>
                      <a 
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <p className="font-semibold text-[#fafafa]">Learn More</p>
                      <Link 
                        to="/learn" 
                        className="text-sm text-[#a1a1aa] hover:text-[#fafafa] transition-colors"
                      >
